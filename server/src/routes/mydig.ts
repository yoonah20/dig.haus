...
// Reads a user's mydig page by username. Returns vinylWall +
// crates; both arrays are always present and may be empty. The
// Shelf tier that originally sat between them was dropped
// 2026-05-17 (never mounted on the client).
