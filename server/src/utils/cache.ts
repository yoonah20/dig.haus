...
export function cacheAlbum(data: Record<string, any>): void {
  ...
  execute(`
    ...
    ON CONFLICT(mbid) DO UPDATE SET
      ...
      apple_music_embed_url = COALESCE(excluded.apple_music_embed_url, apple_music_embed_url),
  ...
  `, [
    ...
    data.spotify_url ?? null, data.apple_music_url ?? null, data.apple_music_embed_url ?? null,
