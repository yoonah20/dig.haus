...
Return ONLY JSON, no prose:
{
  ...
  "score": 85,
  "scoreMax": 100,
  "excerpt": "Exactly two short sentences quoted or paraphrased from the review body, in the original language. Keep each sentence tight — total length ~80-130 chars / ~18-28 words.",
  "excerptKo": "한국어 요약. 매체명 언급 금지. **리뷰어 본인이 1인칭으로 직접 말하는 것처럼** 오직 '~다 / ~한다' 문어체 평서문으로 작성. 존댓말('~합니다', '~입니다', '~네요') 절대 금지, 반말('~해', '~어', '~아') 절대 금지. '리뷰어는/평론가는/필자는' 등 3인칭 주어 금지, '~라고 평가한다/말한다/지적한다' 같은 전달체도 금지. **정확히 2문장 / 총 길이 80-130자**. 한 문장으로 끝내지 말 것(너무 빈약), 3문장 이상으로 늘리지도 말 것(카드가 부풀어 보임). 두 문장 모두 짧고 단단하게. 같은 내용 늘려 쓰거나 부연 설명 붙이지 말 것."
}
...
Return ONLY JSON, no prose:
{
  "score": 85,
  "scoreMax": 100,
  "excerpt": "Exactly two short sentences quoted or paraphrased from the article body, original language. Keep each sentence tight — total length ~80-130 chars / ~18-28 words.",
  "excerptKo": "한국어 요약. 매체명 언급 금지. **리뷰어 본인이 1인칭으로 직접 말하는 것처럼** 오직 '~다 / ~한다' 문어체 평서문으로 작성. 존댓말('~합니다', '~입니다', '~네요') 절대 금지, 반말('~해', '~어', '~아') 절대 금지. '리뷰어는/평론가는/필자는' 등 3인칭 주어 금지, '~라고 평가한다/말한다/지적한다' 같은 전달체도 금지. **정확히 2문장 / 총 길이 80-130자**. 한 문장으로 끝내지 말 것(너무 빈약), 3문장 이상으로 늘리지도 말 것(카드가 부풀어 보임). 두 문장 모두 짧고 단단하게. 같은 내용 늘려 쓰거나 부연 설명 붙이지 말 것."
}
