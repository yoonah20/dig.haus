...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div className="min-h-screen flex items-center justify-center px-6 py-16 bg-panel-strong text-gray-100">
          <div className="max-w-md w-full text-center">
            ...
            <button
              ...
              className="text-sm text-ink bg-accent hover:bg-accent-hover font-semibold px-4 py-2 rounded-full transition-colors"
            >
              새로고침
            </button>
          </div>
